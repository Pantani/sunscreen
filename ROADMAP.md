...
- [x] Heavy integration test harness team — `sunscreen-test-harness` plus specialist agents for offline CI, real Anchor/Codama, real Pinocchio SBF, serve runtime, plugin runtime, frontend typecheck, release distribution, and flake/perf validation.
